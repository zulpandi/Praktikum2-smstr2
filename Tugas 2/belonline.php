        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <form action="belonline.php" method="post">
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <input id="costumer" name="costumer" placeholder="Nama Costumer" type="text"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input name="radio" id="radio_2" type="radio" class="custom-control-input"
            ...
            <div class="col-md-4">
                <div class="border rounded">
                    <div class="bg-success py-3 rounded">
